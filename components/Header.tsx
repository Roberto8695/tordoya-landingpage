  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-primary/10 bg-white/95 backdrop-blur-sm shadow-sm">
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" aria-label="Principal">
        <div className="grid h-20 grid-cols-[1fr_auto] items-center gap-3 md:grid-cols-[1fr_auto_1fr] md:gap-6">
          ...
          <a
            href="#contacto"
            className="hidden min-w-42.5 justify-self-end md:inline-flex items-center justify-center rounded-lg bg-accent px-5 py-2.5 text-[15px] font-bold text-white shadow-md shadow-primary/20 transition-all duration-200 hover:bg-secondary hover:shadow-secondary/30"
          >
            Agenda tu cita
          </a>
